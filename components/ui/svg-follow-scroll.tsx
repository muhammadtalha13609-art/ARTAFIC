...
const Skiper19 = () => {
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-screen w-full flex-col items-center justify-center text-center relative z-10">
        <div className="relative flex flex-col items-center justify-center gap-4 z-20 max-w-4xl px-4">
          <h1 className="font-sans relative z-10 text-7xl font-bold tracking-tight lg:text-9xl text-white drop-shadow-lg">
            Our Services
          </h1>
      ...
      <motion.div
        style={{ translateY }}
        className="rounded-4xl w-full max-w-6xl bg-[#14B8A6] p-8 md:p-16 text-[#0A0A0A] shadow-2xl relative z-30 mt-[100vh]"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[#0A0A0A]">
          <div className="bg-white/95 backdrop-blur p-8 rounded-3xl shadow-lg border border-teal-200">
