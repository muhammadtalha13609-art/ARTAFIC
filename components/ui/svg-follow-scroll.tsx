...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex w-screen flex-col items-center overflow-hidden bg-[#FAFDEE] px-4 text-[#1F3A4B] relative py-20"
    >
      <div className="relative flex w-full max-w-5xl flex-col items-center justify-center min-h-[900px]">
        <div className="absolute top-40 z-20 flex flex-col items-center justify-center text-center max-w-4xl px-4 pointer-events-none">
          <h1 className="font-serif text-7xl font-normal tracking-tight lg:text-9xl text-[#1F3A4B]">
            Our Services
          </h1>
        </div>
        ...
        <svg
          ...
          className="w-full h-full max-w-5xl pointer-events-none"
        >
          <motion.path
      ...
      <motion.div
        ...
        className="rounded-4xl w-full max-w-6xl bg-[#1F3A4B] p-8 md:p-16 text-[#FAFDEE] shadow-2xl relative z-30 -mt-20"
      >
