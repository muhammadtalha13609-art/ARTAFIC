...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[350vh] w-screen flex-col items-center overflow-hidden bg-[#FAFDEE] px-4 text-[#1F3A4B] relative"
    >
      <div className="sticky top-0 flex h-screen w-full flex-col items-center justify-center text-center relative z-10">
        <div className="relative flex flex-col items-center justify-center z-20 max-w-4xl px-4 pointer-events-none">
          <h1 className="font-serif relative z-10 text-7xl font-normal tracking-tight lg:text-9xl text-[#1F3A4B]">
            Our Services
          </h1>
        </div>
